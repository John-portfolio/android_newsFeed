...
public class NewsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewsStory>> {
    ...
    //TODO: add api_key var
    //TODO: add api-key to xml file
    //TODO: method for setting fromDate

    private static final String LOG_TAG = NewsActivity.class.getName();

    private static String fromDate = QueryUtils.createFromDate();

    /**
     * URL for earthquake data from the Guardian dataset
     */
    private final String GUARDIAN_REQUEST_URL =
            "https://content.guardianapis.com/search?q=american%20AND%20business&api-key=4c3cf3b2-86a8-4270-8099-e2410ab530a4&show-fields=byline&order-by=relevance&page-size=50&from-date=" + fromDate;
    ...
    public Loader<List<NewsStory>> onCreateLoader(int i, Bundle bundle) {
        ...
        return new NewsStoryLoader(this, GUARDIAN_REQUEST_URL);
    }

    @Override
    public void onLoadFinished
            (Loader<List<NewsStory>> loader, List<NewsStory> news) {
